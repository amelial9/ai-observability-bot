...
try:
    from observability import record_escalation, add_span_attributes
    ENHANCED_OBSERVABILITY = True
    print("✅ Main: Enhanced observability loaded")
except ImportError:
    ENHANCED_OBSERVABILITY = False
    print("ℹ️  Main: Running without enhanced observability")
    ...
    try:
        ...
        if global_frustrated_count >= 3 and not escalation_triggered:
            ...
            if current_span:
                ...
                current_span.set_attribute("escalation.frustrated_count", global_frustrated_count)
                current_span.set_attribute("escalation.total_messages", len(global_conversation_history))
